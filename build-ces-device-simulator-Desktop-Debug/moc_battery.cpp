...
#include "../../../ces-backup/ces/3004-CES-Device-Simulator/ces-device-simulator/battery.h"
...
QT_MOC_LITERAL(1, 8, 16), // "lowBatterySignal"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "Battery\0lowBatterySignal\0"
};
...
void Battery::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->lowBatterySignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Battery::lowBatterySignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Battery::lowBatterySignal(int _t1)
{

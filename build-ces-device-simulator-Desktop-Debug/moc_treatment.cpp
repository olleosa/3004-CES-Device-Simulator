...
#include "../../../ces-backup/ces/3004-CES-Device-Simulator/ces-device-simulator/treatment.h"
...
QT_MOC_LITERAL(1, 10, 23), // "treatmentFinishedSignal"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "Treatment\0treatmentFinishedSignal\0"
};
...
void Treatment::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->treatmentFinishedSignal(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Treatment::treatmentFinishedSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Treatment::treatmentFinishedSignal()
{
